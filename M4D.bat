...
chcp 65001
cls
echo.                                    WELCOME TO MAD OPTIMIZER /(-_-)\ LAG FIX 5.2
echo.
echo.
echo                                         ███╗   ███╗ █████╗ ██████╗ 
echo                                         ████╗ ████║██╔══██╗██╔══██╗
...
echo.     :                                            :
echo.      *********************************************
SET /P tedexe=Please Choose the Service You Want To Use:
IF %tedexe%==1 Goto GPU
IF %tedexe%==2 Goto fix
IF %tedexe%==3 Goto FPS
IF %tedexe%==4 Goto CPU
IF %tedexe%==0 Goto Exit
